-- ============================================================================
-- SolRelay Autonomous System - Supabase Schema (FIXED)
-- Created: 2026-02-08
...
-- Indexes for blocked_entities (FIXED - removed NOW() from WHERE clause)
...
CREATE INDEX IF NOT EXISTS idx_blocked_entities_until ON blocked_entities(blocked_until);
