/*
 * STRIPE MESH GRADIENT — WebGL Implementation
 * Extracted for SolRelay experiment
 */
...
// ── MiniGl: Stripe's lightweight WebGL engine ──
class MiniGl {
...
class Gradient {
  constructor(...t) {
    ...
    e(this, "amp", 60);  // Custom: wave amplitude
    e(this, "seed", 5);
    e(this, "freqX", 14e-5);
    e(this, "freqY", 29e-5);
    ...
    e(this, "noiseSpeed", 9e-6);  // Custom: slower animation
    ...
    e(this, "handleMouseUp", () => { this.isMouseDown = !1; });
  ...
  async connect() {
    ...
    this.conf = {
      presetName: "",
      wireframe: false,
      density: [0.02, 0.052],  // Density 2 (lower = less dense mesh)
      zoom: 1,
      rotation: 0,
      playing: true,
    };
    ...
    this.uniforms = {
      ...
      u_global: new this.minigl.Uniform({
        value: {
          ...
          noiseSpeed: new this.minigl.Uniform({ value: this.noiseSpeed }),
        },
        type: "struct",
      }),
...
// Make Gradient class available globally for React component
